        ...
        return <NavigationRow className='sidebar-entry-date'>
            ...
            <NavigationGroup>
                ...
                {isAuthorized && <FlatIcon circle>
                    <Icon title={`Leave ${space.name}`} className="fas fa-user-minus clr-silver" onClick={(event) => {
                        event.preventDefault();
                ...
                {isAuthorized && isOwner && <FlatIcon circle>
                    <Icon title={`Delete ${space.name}`} className="fas fa-trash clr-silver" onClick={(event) => {
                        event.preventDefault();
